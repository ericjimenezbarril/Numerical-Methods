...
//Los valores de ambos arrays son declaran al principio del programa y son los mismos que habíamos declarado en 2b, para comprobar que la nueva expresión soluciona los errores de cancelación.
//Los valores introducidos se corresponden con los valores de a, b y c de la expresión ax^2 +bx +c respectivamente en cada uno de los arrays.
