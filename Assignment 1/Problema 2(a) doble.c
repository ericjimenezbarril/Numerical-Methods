...
///DESCRIPCIÓN
//En este programa comenzamos declarando un array de doubles llamado 'a' de 3 componenetes, y dos variables también doubles 'x_0' y 'x_1'.
//Las componentes del array las introducirá el lector por pantalla una vez compilado el programa. Se escanea un '%lf' ya que queremos escanear doubles.
...
//Observamos que en este caso utilizamos sqrt() para calcular la raíz cuadrada de un double (precisión doble).
